...
export default function App() {
  ...
  const highlightedId =
    filteredCategories.find((c) => c.id === activeId)?.id ??
  ...
  return (
    <div className="app">
      <header className="header">
        ...
        <p>
          Where aromatic biryani meets artisan coffee — explore our full menu
          below.
        </p>
        ...
        <main className="menu">
          {filteredCategories.length === 0 ? (
            <p className="no-results">
              Try a different search — coffee, biryani, lassi...
            </p>
          ) : (
            filteredCategories.map((cat) => (
